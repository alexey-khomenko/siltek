...
window.calculatorData = function () {
  ...
  return {
    ...
    loadProducts: function loadProducts() {
      ...
      this.cleanStep2();
      setTimeout(function () {
        _this.load(mode).then(function (r) {
    ...
    loadColors: function loadColors() {
      ...
      this.cleanStep2();
      setTimeout(function () {
        _this2.load(mode).then(function (r) {
          return _this2.colors = r;
        });
      }, 300);
    },
    loadPacks: function loadPacks() {
      ...
      this.cleanStep2();
      setTimeout(function () {
        _this3.load(mode).then(function (r) {
          return _this3.packs = r;
        });
      }, 300);
    },
    loadBases: function loadBases() {
      ...
      this.cleanStep2();
      setTimeout(function () {
        _this4.load(mode).then(function (r) {
          return _this4.bases = r;
        });
      }, 300);
    },
    loadPigments: function loadPigments() {
      ...
      setTimeout(function () {
        ...
        _this5.load(mode).then(function (r) {
          _this5.photo = r.photo;
          _this5.pigments = r.pigments;
          _this5.pigments_price = parseFloat(r.pigments_price).toFixed(2);
    ...
    load: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(mode) {
